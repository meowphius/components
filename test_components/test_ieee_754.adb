...
begin
   ...
   declare
      ...
      procedure Check (X, Y : String; LT, LE, GT, GE : Boolean) is
         Left  : constant Integer_128 := Value (X);
         Right : constant Integer_128 := Value (Y);
      begin
      ...
      procedure Check (X, Y : Integer_128; Error : String) is
      begin
         if X /= Y then
            Raise_Exception
            (  Data_Error'Identity,
      ...
      procedure Verify (X : Integer_128; S : String)  is
