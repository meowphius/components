...
--        Generic_Modular                          Autumn, 2014       --
--  Implementation                                                    --
--                                Last revision :  09:01 17 Oct 2020  --
--                                                                    --
...
package body Strings_Edit.Streams.Generic_Modular is
   ...
   begin
      loop
         ...
         exit when Last /= 1;
         Result :=
            Result + 2 ** Power * Number (Buffer (1) and 16#7F#);
         if Old > Result then
            Raise_Exception
            (  Data_Error'Identity,
               "Number is too large"
...
end Strings_Edit.Streams.Generic_Modular;
